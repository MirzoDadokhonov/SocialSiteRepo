...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240425173658_preFinalDbReady")]
    partial class preFinalDbReady
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialSiteClassLibrary.Entities.Friend", b =>
                {
                    b.HasOne("SocialSiteClassLibrary.Entities.User", null)
                        .WithMany("Friends")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SocialSiteClassLibrary.Entities.Like", b =>
                {
                    b.HasOne("SocialSiteClassLibrary.Entities.Comment", null)
                        .WithMany("Likes")
                        .HasForeignKey("CommentId");

                    b.HasOne("SocialSiteClassLibrary.Entities.Post", null)
                        .WithMany("Likes")
                        .HasForeignKey("PostId");
